...
<div class="container">
    ...
    <a class="btn-create" href="<?=base_url('/admin/user/create')?>"><img src="<?=base_url('/img/add.png')?>"/></a>
    <table>
        <thead>
        <tr>
            <th>#</th>
        ...
        if (!empty($users)) :
            foreach ($users as $user) :
                ...
                <tr>
                    ...
                    <td><?= $user->status ?></td>
                    <td>
                        <a class="btn-action" href="<?=base_url("admin/user/show/{$user->id}")?>"><img src="<?=base_url('/img/eye.png')?>"/></a>
                        <a class="btn-action" href="<?=base_url("admin/user/edit/{$user->id}")?>"><img src="<?=base_url('/img/edit.png')?>"/></a>
                    </td>
                </tr>
            <?php
            endforeach;
